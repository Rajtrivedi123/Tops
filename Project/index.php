    ...
    <div class="row">
      <div class="col-md-12">
        <div class="full">
          <div class="main_heading text_align_center">
            <h2>Our Products</h2>
            <p class="large">We provide learning on multiple languages.</p>
          </div>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 margin_bottom_30_all">
        <div class="product_list">
          <div class="product_img"> <img class="img-responsive" src="images/php.png" alt="Images to be placed wait ✋"> </div>
          <div class="product_detail_btm">
            <div class="center">
              <h4><a href="it_shop_detail.php">PHP</a></h4>
            </div>
             
            <div class="product_price">
              <p><span class="old_price">₨ 2500</span><br>
              <span class="new_price">₨ 2000</span></p>
            </div>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 margin_bottom_30_all">
        <div class="product_list">
          <div class="product_img"> <img class="img-responsive" src="images/java.png" alt="Images to be placed wait ✋"> </div>
          <div class="product_detail_btm">
            <div class="center">
              <h4><a href="it_shop_detail.php">Java</a></h4>
            </div>
             
            <div class="product_price">
              <p><span class="old_price">₨ 2000</span><br>
              <span class="new_price">₨ 1800</span></p>
            </div>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 margin_bottom_30_all">
        <div class="product_list">
          <div class="product_img"> <img class="img-responsive" src="images/python.png" alt="Images to be placed wait ✋"> </div>
          <div class="product_detail_btm">
            <div class="center">
              <h4><a href="it_shop_detail.php">Python</a></h4>
            </div>
             
            <div class="product_price">
              <p><span class="old_price">₨ 3000</span><br>
              <span class="new_price">₨ 2600</span></p>
            </div>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 margin_bottom_30_all">
        <div class="product_list">
          <div class="product_img"> <img class="img-responsive" src="images/android.png" alt="Images to be placed wait ✋"> </div>
          <div class="product_detail_btm">
            <div class="center">
              <h4><a href="it_shop_detail.php">Android</a></h4>
            </div>
             
            <div class="product_price">
              <p><span class="old_price">₨ 2800</span><br> 
               <span class="new_price">₨ 2500</span></p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 margin_bottom_30_all">
        <div class="product_list">
          <div class="product_img"> <img class="img-responsive" src="images/cpp.png" alt="Images to be placed wait ✋"> </div>
          <div class="product_detail_btm">
            <div class="center">
              <h4><a href="it_shop_detail.php">C++</a></h4>
            </div>
             
            <div class="product_price">
              <p><span class="old_price">₨ 1200</span><br>
              <span class="new_price">₨ 1000</span></p>
            </div>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 margin_bottom_30_all">
        <div class="product_list">
          <div class="product_img"> <img class="img-responsive" src="images/html.png" alt="Images to be placed wait ✋"> </div>
          <div class="product_detail_btm">
            <div class="center">
              <h4><a href="it_shop_detail.php">Html</a></h4>
            </div>
             
            <div class="product_price">
              <p><span class="old_price">₨ 1000</span><br>
               <span class="new_price">₨ 800</span></p>
            </div>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 margin_bottom_30_all">
        <div class="product_list">
          <div class="product_img"> <img class="img-responsive" src="images/css.png" alt="Images to be placed wait ✋"> </div>
          <div class="product_detail_btm">
            <div class="center">
              <h4><a href="it_shop_detail.php">CSS</a></h4>
            </div>
             
            <div class="product_price">
              <p><span class="old_price">₨ 1100</span> <br>
               <span class="new_price">₨ 900</span></p>
            </div>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 margin_bottom_30_all">
        <div class="product_list">
          <div class="product_img"> <img class="img-responsive" src="images/c-sharp.png" alt="Images to be placed wait ✋"> </div>
          <div class="product_detail_btm">
            <div class="center">
              <h4><a href="it_shop_detail.php">C Sharp</a></h4>
            </div>
             
            <div class="product_price">
              <p><span class="old_price">₨ 1800</span><br>
              <span class="new_price">₨ 1200</span></p>
            </div>
          </div>
        </div>
      </div>
